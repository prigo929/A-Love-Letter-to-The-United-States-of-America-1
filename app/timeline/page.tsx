...
export const metadata: Metadata = {
  title: 'Timeline',
  description: 'A timeline of America’s defining breakthroughs, victories, and national milestones.',
}
...
const previewItems = [
  {
    ...
    answer: 'The founding era, the Constitution, and the institutional framework that allowed the country to scale without losing its original governing architecture.',
  },
  {
    id: 'industrial',
    question: 'Will innovation milestones be included?',
    answer: 'Yes. The timeline page is intended to connect inventions, economic scale, war production, scientific breakthroughs, and cultural exports into one chronological narrative.',
  },
]
