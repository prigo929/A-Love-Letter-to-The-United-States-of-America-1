...
export const metadata: Metadata = {
  ...
  keywords: [
    'United States', 'America', 'USA', 'American history',
    'US economy', 'US military', 'national parks', 'Constitution',
    'American culture', 'American innovation', 'Silicon Valley',
    'American universities', 'American exceptionalism',
  ],
