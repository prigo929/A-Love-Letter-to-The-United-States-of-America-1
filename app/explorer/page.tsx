      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="mb-12 max-w-3xl">
          ...
          <p className="font-body text-lg leading-relaxed text-white/60">
            The interactive map preview on the home page now links here. This
            page is reserved for the deeper state explorer with richer state
            facts, rankings, and regional stories.
          </p>
        </div>
