...
export const NAV_SECTIONS = [
    ...
    items: [
      {
        ...
        description: "Burgers, Coke, BBQ & more",
      },
      {
        label: "Music Genres",
        href: "/culture/music-genres",
        description: "Jazz, Blues, Rock, Hip Hop — all American",
      },
      {
        label: "Fashion",
        href: "/culture/fashion",
        description: "Blue jeans to sneakers",
      },
      {
        label: "Film & Hollywood",
        href: "/culture/film-and-storytelling",
        description: "#1 film industry on Earth",
      },
      {
        label: "Iconic Brands",
        href: "/culture/companies-brands",
        description: "Apple, Disney, Nike & the rest",
      },
      {
        label: "Sports",
        href: "/culture/sports",
        description: "NFL, NBA, MLB — American originals",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        label: "Income & Wages",
        href: "/quality-of-life/income-and-wages",
        description: "Highest median wages on Earth",
      },
      {
        label: "Housing",
        href: "/quality-of-life/housing",
        description: "2,500 sq ft average — 3x the world",
      },
      {
        label: "Food Abundance",
        href: "/quality-of-life/food-abundance",
        description: "Most calories per capita",
      },
      {
        label: "Transportation",
        href: "/quality-of-life/transportation",
        description: "The car culture that built freedom",
      },
      {
        label: "Leisure",
        href: "/quality-of-life/leisure",
        description: "Entertainment capital of Earth",
      },
    ],
  },
  {
